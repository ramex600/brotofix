...
export const ProfileEditDialog = ({
  ...
  open: controlledOpen,
  onOpenChange
}: ControlledProfileEditDialogProps) => {
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4 py-4">
          <div className="space-y-2">
            ...
            <Input id="edit-name" placeholder="e.g., John Doe" value={name} onChange={e => setName(e.target.value)} maxLength={100} />
          </div>

          <div className="space-y-2">
            <Label htmlFor="edit-student-id">Student ID *</Label>
            <Input id="edit-student-id" placeholder="e.g., BT2024001" value={studentId} onChange={e => setStudentId(e.target.value)} maxLength={50} />
          </div>

          <div className="space-y-2">
            <Label htmlFor="edit-course">Course *</Label>
            <Input id="edit-course" placeholder="e.g., Full Stack Development" value={course} onChange={e => setCourse(e.target.value)} maxLength={100} />
          </div>

          <div className="space-y-2">
            <Label htmlFor="edit-email">Email (Optional)</Label>
            <Input id="edit-email" type="email" placeholder="your.email@example.com" value={email} onChange={e => setEmail(e.target.value)} maxLength={255} />
          </div>
        </div>
